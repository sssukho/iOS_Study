...
class signUpVC: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        profileImg.addGestureRecognizer(avaTap)
        
        //alignment
        profileImg.frame = CGRect(x: self.view.frame.size.width / 2 - 40, y: 40, width: 80, height: 80)
        usernameTxt.frame = CGRect(x: 10, y: profileImg.frame.origin.y + 90, width: self.view.frame.size.width - 20, height: 30)
    ...
    @IBAction func signUpBtn_Clicked(_ sender: Any) {
        ...
        let avaData = profileImg.image?.jpegData(compressionQuality: 0.5)
